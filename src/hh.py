...
class HeadHunterAPI(Job):
    """
            ...
            Attributes:
                __response_hh: return an object Response from address 'https://api.hh.ru/vacancies'
    ...
    def __init__(self):
        self.__response_hh = requests.get('https://api.hh.ru/vacancies')
        self._response = self.__response_hh.text
